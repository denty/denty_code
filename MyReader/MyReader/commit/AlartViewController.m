...
{
    [super viewDidLoad];
    [self.view setBackgroundColor:[UIColor  colorWithIntRed:0 intGreen:0 intBlue:0 alpha:0.5]];
    self.titleView = [[UIView alloc] initWithFrame:CGRectMake(20, -70, 280, 70)];
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    [OKlayer setFrame:CGRectMake(0, 50, 140, 40)];
    ...
    [editLayer setFrame:CGRectMake(140, 50, 140, 40)];
    ...
    UIView* titleHolder = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.titleView.width, self.titleView.height)];
